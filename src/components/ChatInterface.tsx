        ...
        {isSidebarOpen && (
          ...
          >
            <div className="p-6 border-b border-math-line flex items-center justify-between">
              ...
              <button onClick={() => setIsSidebarOpen(false)} className="text-math-ink/50 hover:text-white">
                <X size={18} />
              </button>
            </div>
                  ...
                  {savedMessages.length === 0 ? (
                    ...
                    savedMessages.map((m, i) => (
                      <div key={i} className="p-3 bg-black/40 border border-math-line rounded-sm">
                        ...
                        <button 
                          onClick={() => setMessages(prev => prev.map(msg => msg === m ? { ...msg, isSaved: false } : msg))}
                      ...
                      {msg.role === 'model' && i !== 0 && !msg.quiz && (
                        <div className="mt-4 pt-4 border-t border-math-line/30">
                          <div className="flex items-center justify-between gap-4">
                            ...
                            {msg.rating && !msg.feedback && feedbackIndex === i && (
                              <button 
                          ...
                          {feedbackIndex === i && (
                            ...
                            >
                              <textarea
                                value={msg.feedback || ''}
                                onChange={(e) => handleFeedback(i, e.target.value)}
